AR = '/usr/bin/ar'
ARFLAGS = 'rcs'
CCFLAGS = ['-g', '-O3', '-Wall', '-D_FILE_OFFSET_BITS=64', '-D_LARGEFILE_SOURCE', '-msse2']
...
CPPPATH_NODE = '/Users/messel/local/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-O3', '-Wall', '-D_FILE_OFFSET_BITS=64', '-D_LARGEFILE_SOURCE', '-msse2']
CXXFLAGS_DEBUG = ['-g']
...
LIBDIR = '/Users/messel/.node_libraries'
LIBPATH_NODE = '/Users/messel/local/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/messel/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/Users/messel/local'
